...
def load_and_interpolate_data( accel_csv, gravity_csv, gyro_csv, gps_csv):
    ...
    accel_df = accel_df.rename(columns={'Accelerometer_Y': 'ax', 'Accelerometer_X': 'ay', 'Accelerometer_Z': 'az'})
    gravity_df = gravity_df.rename(columns={'GravityVector_Y': 'gx', 'GravityVector_X': 'gy', 'GravityVector_Z': 'gz'})
    gyro_df = gyro_df.rename(columns={'Gyroscope_Y': 'gyro_x', 'Gyroscope_X': 'gyro_y', 'Gyroscope_Z': 'gyro_z'})
    ...
    # gravity_df['time'] = pd.to_datetime(gravity_df['time'], errors='coerce')
    # gyro_df['time'] = pd.to_datetime(gyro_df['time'], errors='coerce')
...
def process_and_save_spatial(merged_df):
    ...
    # gdf_w_geometry.to_csv('geo_data.csv', index=False)
    ...
    print(f"Geometry data saved to {output_filename}")
    
    return road_w_merged

ACCEL_CSV = r"C:\Users\is2648257\Documents\Videos\Test_videos_04\Separ_test_01\004\2026-01-19-10-02-36\accelerometer.csv"
GRAVITY_CSV = r"C:\Users\is2648257\Documents\Videos\Test_videos_04\Separ_test_01\004\2026-01-19-10-11-19\gravity_vector.csv"
GYRO_CSV = r"C:\Users\is2648257\Documents\Videos\Test_videos_04\Separ_test_01\004\2026-01-19-10-06-56\gyroscope.csv" 
GPS_CSV = r"C:\Users\is2648257\Documents\Videos\Test_videos_04\Separ_test_01\004\2026-01-19-10-11-19\videos_metadata.csv"            
...
def main():
    ...
    for segment in segments:
        ...
        if result:
            results.append({
                ...
                'start_distance': segment['from_km'],
                'end_distance': segment['to_km'],
                'iri': result['iri'],
                'std': result['std'],
    ...
    if results:
        ...
        distances = [(r['dist_start'] + r['dist_end']) / 2 for r in results]
